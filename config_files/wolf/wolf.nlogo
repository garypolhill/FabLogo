extensions [ mgr ]
globals [ max-sheep max-mem start-cpu-time ]  ; don't let the sheep population grow too large
...
to setup
  ...
  set start-cpu-time mgr:cpu-time
  set max-mem mgr:mem
...
;  if not any? wolves and count sheep > max-sheep [ user-message "The sheep have inherited the earth" stop ]
  ...
  tick
  display-labels
  set max-mem max (list max-mem mgr:mem)
end
...
@#$#@#$#@
<experiments>
  <experiment name="estimate-resource-use" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>count sheep = 0 
 or count wolves = 0
 or count sheep &gt; 10000
 or count wolves &gt; 10000</exitCondition>
    <metric>mgr:mem</metric>
    <metric>mgr:cpu-time</metric>
  ...
  <experiment name="estimate-resource-use-properly" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>count sheep = 0 
 or count wolves = 0
 or count sheep &gt; 10000
 or count wolves &gt; 10000</exitCondition>
    <metric>max-mem</metric>
    <metric>mgr:cpu-time - start-cpu-time</metric>
    <enumeratedValueSet variable="wolf-gain-from-food">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="show-energy?">
    ...
    <enumeratedValueSet variable="same-setup?">
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="estimate-resource-use-properly-50000" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>count sheep = 0 
 or count wolves = 0
 or count sheep &gt; 50000
 or count wolves &gt; 50000</exitCondition>
    <metric>max-mem</metric>
    <metric>mgr:cpu-time - start-cpu-time</metric>
    <enumeratedValueSet variable="wolf-gain-from-food">
      <value value="20"/>
  ...
  <experiment name="estimate-resource-use-same-setup-50000" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>count sheep = 0 
 or count wolves = 0
